...
import { dicDepartment, operation } from "utils/cols";
import { getDicDepartment as getList } from "store/async";
import { HomeState as BaseState } from "utils/extends";

@connect(
  state => ({
    ...state.dictionary.department
  }),
  { getList }
)
class Department extends BaseState {
  constructor(props) {
    super(props);
